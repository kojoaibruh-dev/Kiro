...
do
    ...
    --
    function sections:PlayerList(info)
        local info = info or {}
        local callback = info.callback or info.callBack or info.Callback or info.CallBack or function()end
        --
        local window = self.window
        ...
        local header_frame = utility:Create("Frame", {Vector2.new(4, playerList.axis), section.section_frame}, {
            Size = utility:Size(1, -8, 0, 20, section.section_frame),
            Position = utility:Position(0, 4, 0, playerList.axis, section.section_frame),
            Color = theme.light_contrast,
            Visible = page.open
        }, section.visibleContent)
        --
        -- Header outline
        local header_outline = utility:Create("Frame", {Vector2.new(0, 0), header_frame}, {
            Size = utility:Size(1, 0, 1, 0, header_frame),
            Position = utility:Position(0, 0, 0, 0, header_frame),
            Color = theme.outline,
            Visible = page.open
        }, section.visibleContent)
        --
        ...
        --
        local header_team = utility:Create("TextLabel", {Vector2.new(header_frame.Size.X * 0.5, 3), header_frame}, {
            Text = "Team",
            Size = theme.textsize,
            Font = theme.font,
            Color = theme.textcolor,
            OutlineColor = theme.textborder,
            Position = utility:Position(0.4, 0, 0, 3, header_frame),
            Visible = page.open
        }, section.visibleContent)
        --
        local header_status = utility:Create("TextLabel", {Vector2.new(header_frame.Size.X * 0.75, 3), header_frame}, {
            Text = "Status",
            Size = theme.textsize,
            Font = theme.font,
            Color = theme.textcolor,
            OutlineColor = theme.textborder,
            Position = utility:Position(0.7, 0, 0, 3, header_frame),
            Visible = page.open
        }, section.visibleContent)
        --
        ...
        function playerList:AddPlayer(playerName, team, status)
            ...
            --
            -- Row background
            local row_frame = utility:Create("Frame", {Vector2.new(4, playerRow.axis), section.section_frame}, {
            ...
            --
            -- Row outline
            local row_outline = utility:Create("Frame", {Vector2.new(0, 0), row_frame}, {
            ...
            --
            -- Team
            local row_team = utility:Create("TextLabel", {Vector2.new(row_frame.Size.X * 0.5, 2), row_frame}, {
                Text = team or "Neutral",
                Size = theme.textsize,
                Font = theme.font,
                Color = theme.textcolor,
                OutlineColor = theme.textborder,
                Position = utility:Position(0.4, 0, 0, 2, row_frame),
                Visible = page.open
            }, section.visibleContent)
            --
            -- Status
            local row_status = utility:Create("TextLabel", {Vector2.new(row_frame.Size.X * 0.75, 2), row_frame}, {
                Text = status or "None",
                Size = theme.textsize,
                Font = theme.font,
                Color = status == "Client" and Color3.fromRGB(100, 200, 255) or theme.textcolor,
                OutlineColor = theme.textborder,
                Position = utility:Position(0.7, 0, 0, 2, row_frame),
                Visible = page.open
            }, section.visibleContent)
            --
