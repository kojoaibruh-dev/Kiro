...
do
    ...
    function library:AddHomePage(discordLink)
        ...
        -- Executor Info
        local executorYPos = discordLink and discordLink ~= "" and 249 or 166
        ...
        -- Update canvas size
        HomeContainer.CanvasSize = UDim2.new(0, 0, 0, executorYPos + 70)
        ...
        task.spawn(function()
            while true do
                ...
                if PlayersCount then
                    PlayersCount.Text = #game:GetService("Players"):GetPlayers() .. " players currently online"
                end
            end
        end)
